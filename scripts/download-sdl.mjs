...
await Fs.promises.rm(C.dir.C.dir.sdl, { recursive: true }).catch(() => {})
await Fs.promises.mkdir(C.dir.C.dir.sdl, { recursive: true })
const tar = Tar.extract({ gzip: true, C: C.dir.C.dir.sdl })
